import 'dart:io';
import 'package:flutter/foundation.dart'; // kIsWeb 등을 사용하기 위해 추가
...
class AdService {
  ...
  /// 어린이 대상 앱에 맞춘 전역 광고 요청 설정.
  static RequestConfiguration get childSafeRequestConfiguration =>
  ...
  /// 현재 디바이스가 AdMob을 지원하는지 확인 (모바일 한정)
  ...
  static Future<bool> showRewardedAd() async {
    if (!_isSupportedPlatform) {
      debugPrint('지원되지 않는 플랫폼입니다 (광고 시청 생략 처리)');
      return false;
    }
